...
public class House {
    public static House sample = new House(2197, "Cho thuê nhà BT 80 m2 trên nền đất 215 m2, đường Phùng Khoang", "Số điện thoại: 0913593202",
 ...
 */ 
    ...
    public House(int id, String title, String descirption, String name, Address specAddress, int numBedrooms,
